...
from app.hotel.models.ontology import Employee, RoomType
...
def register_price_actions(
    ...
    def handle_update_price(
        ...
        from app.hotel.models.ontology import RatePlan
    ...
    def handle_create_rate_plan(
        ...
        from app.hotel.services.room_service import RoomService
        from app.hotel.services.price_service import PriceService
        from app.hotel.models.schemas import RatePlanCreate
