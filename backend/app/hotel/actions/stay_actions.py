...
from app.hotel.actions.base import CheckoutParams, CheckinParams, ExtendStayParams, ChangeRoomParams
...
def register_stay_actions(
    ...
    def handle_checkin(
        ...
        """预订入住"""
        from app.hotel.models.schemas import CheckInFromReservation
        from app.hotel.models.ontology import Reservation, Room
        ...
        try:
            ...
            if params.room_number:
                ...
                from app.hotel.models.ontology import RoomStatus
                room = db.query(Room).filter(
    ...
    def handle_extend_stay(
        ...
        **context
        ...
        """续住"""
        from app.hotel.models.schemas import ExtendStay
    ...
    def handle_change_room(
        ...
        """换房"""
        from app.hotel.models.schemas import ChangeRoom
