"""
Hotel domain ORM models (Ontology Objects).

All hotel business entities: rooms, guests, reservations, stays, bills, tasks, employees.
Each property carries security level marking for attribute-level access control.
Domain keywords defined via @ontology_entity and @ontology_property decorators.
"""
