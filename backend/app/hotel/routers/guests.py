...
from app.hotel.models.ontology import Employee, GuestTier
from app.hotel.models.schemas import GuestCreate, GuestUpdate, GuestResponse, GuestDetailResponse
from app.hotel.services.guest_service import GuestService

# 导入新的 GuestServiceV2 (SPEC-58)
try:
    from app.hotel.services.guest_service_v2 import GuestServiceV2
