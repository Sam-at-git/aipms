...
from app.hotel.models.ontology import Employee, TaskType, TaskStatus, EmployeeRole
from app.hotel.models.schemas import TaskCreate, TaskAssign, TaskUpdate, TaskResponse
