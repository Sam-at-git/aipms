...
- 客人规则（等级升级、黑名单、VIP服务）
"""
from core.domain.rules.room_rules import register_room_rules
from core.domain.rules.pricing_rules import register_pricing_rules
from core.domain.rules.guest_rules import register_guest_rules
