...
def _resolve_update_schema(config: SmartUpdateConfig):
    ...
    import app.models.schemas as generic_schemas
    schema = getattr(generic_schemas, config.update_schema, None)
    if schema is not None:
        return schema
    import app.hotel.models.schemas as hotel_schemas
    return getattr(hotel_schemas, config.update_schema)
